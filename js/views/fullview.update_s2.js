(function ($) {
    ...
    // Module for handling Update logic in Full view details panel for S2
    var FVUpdateStepSpecific = {
        /**
         * Initializes the Update logic in Full view details panel for S2 module.
        ...
        displayTimeline: function () {
            return !App.fieldObject.requestable || App.fieldObject.reviewDone;
        },
        /**
