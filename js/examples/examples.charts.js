	...
	*/
		if ($('#morrisStacked').get(0)) {
			Morris.Bar({
				...
				xkey: 'y',
				ykeys: ['GDSN', 'VI', 'R', 'C', 'SAP', 'IWC', 'PIWC', 'CR', 'SAPI', 'SD', 'RFP', 'RIWC', 'SDS', 'MAD', 'CPA'],
				labels: ['GDSN', 'VI', 'Review', 'Correction', 'SAP', 'IWC', 'PIWC', 'CR', 'SAPI', 'SD', 'RFP', 'RIWC', 'SDS', 'MAD', 'CPA'],
				barColors: ['#ed7d31', '#4472c4', '#4472c4', '#cd2c23', '#00008b', '#00008b', '#ed7d31', '#ed7d31', '#ed7d31', '#ed7d31', '#ed7d31', '#FF8C00', '#FF8C00', '#70ad47', '#70ad47'],
				fillOpacity: 0.7,
				smooth: false,
				stacked: true,
				hideHover: true
		...
		*/
		(function () {
			if ($('#ChartistStackedChart').get(0)) {
				// Set the desired height for the chart container
				...
				new Chartist.Bar('#ChartistStackedChart', {
					...
					axisY: {
						labelInterpolationFnc: function (value) {
							// Customize Y-axis label based on your requirements
							return 'Days';
						}
					}
